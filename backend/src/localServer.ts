...
import { CreateJobRequestSchema, CreateJobResponseSchema, JobRecordSchema, type JobRecord } from "@invoice-extractor/schema";
 ...
 * needed - this is what `pnpm dev` runs so a reviewer can try the whole
 * thing without deploying.
 */
